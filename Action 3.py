import pandas as pd
#读取数据
df=pd.read_csv('E:/14 study\Python/2021_黑马训练营/L1/L1/car_data_analyze/car_complain.csv')
...
result2.to_excel("E:/14 study\Python/2021_黑马训练营/L1/L1/car_data_analyze/result2 brand.xlsx",index=False)
print(result2)
...
result4.to_excel("E:/14 study\Python/2021_黑马训练营/L1/L1/car_data_analyze/result4 model.xlsx",index=False)
print(result4)
